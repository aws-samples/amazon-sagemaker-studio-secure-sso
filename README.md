...
1. Run the following commands to build and deploy the SAM Application. Replace the ```'<Identity Store ID>'``` and ```'<UserName>'``` with values from your AWS SSO configuration.
```sh
